...
* [GraalVM Native Image Support](https://docs.spring.io/spring-boot/docs/3.0.6-SNAPSHOT/reference/html/native-image.html#native-image)
...
* [Configure AOT settings in Build Plugin](https://docs.spring.io/spring-boot/docs/3.0.6-SNAPSHOT/maven-plugin/reference/htmlsingle/#aot)
...
```
$ docker run --rm -p 8080:8080 something:0.0.1-SNAPSHOT
```
